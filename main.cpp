//============================================================================
// Name        : main.cpp
// Test File   : main.cpp (this)
// Version     : 1.0
// Description :      This is the implementation and testing file for the Maze
//                  as a whole.  Any Maze can, in theory, be created from a
//                  file that uses the proper characters to represent each
//                  type of Space, and in which there are exactly 20 lines
//                  of 20 characters each.  You would just need to change the
//                  name of the file for the ifstream inData (under global
//                  variables.
//                    In the current unmodified version (Version 1.0), the code
//                  reads from the file "maze.txt" to create a Maze (defined as
//                  a typedef in functions.h) and prints it to the console.  You
//                  will need to enter full screen on the console to see the
//                  complete maze.
// CODING CLUB :      The challenge!  Members should familiarize themselves with
//                  the functions and attempt to place the Player object in
//                  the maze.  Then, try to get the Player moving through the
//                  maze.  For now, the maze can just re-print after the
//                  Player moves.
// Author      : Tess Tucker
//============================================================================
